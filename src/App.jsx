...
import { FaDiscord, FaFacebook, FaFacebookSquare } from "react-icons/fa";
import './App.css'
...
<div className="bg-black w-full h-full md:h-min-screen">
  <div className=" m-auto">
    <div className="w-full z-0 relative md:min-h-[24rem]">
    ...
    <section className="text-gray-100 bg-[#1F1F1F] body-font">
  <div className="container px-5 md:py-20 py-10 mx-auto flex flex-wrap">
    ...
    <div className="flex flex-wrap mb-4 -mx-2 md:space-y-0 space-y-6">
        <div className="px-2 md:w-1/2 w-full">
          <div className="flex flex-wrap w-full group hover:md:py-[0px] md:py-24 py-4 px-2 relative">
...
{showTooltip && (
  ...
  <p className=' text-sm'>Please join manually from console/server list if the link is not working</p>
        ...
        <div className="px-2 md:w-1/2 w-full">
          <div className="flex flex-wrap group w-full hover:md:py-0 md:py-24 py-4 md:px-10 px-2 relative">
...
<div className=' absolute bottom-5 right-0 flex flex-col justify-end items-end'>
  <a href='http://mc.glitchedrealms.com/' target='_blank' className="mt-3 text-indigo-500 inline-flex" >
    ...
    <p className=' text-sm'>Please join manually from console/server list if the link is not working</p>
      ...
      <div className="flex flex-wrap w-full hover:md:py-0 md:py-[90px] px-10 relative mb-4 group">
  ...
  <div className="container mx-auto flex md:py-0 py-5 md:pl-5 md:flex-row flex-col items-center">
    <div className=" md:w-1/2 flex flex-col mb-16 md:mb-0 items-center text-center">
      ...
      <div className="flex justify-center">
        <a href='https://docs.google.com/forms/d/e/1FAIpQLSfmHa64Lv05yPcZbmF7fG8w_NXLWnaxYI_iBtJiw4fCUQugbA/viewform?usp=sf_link' target='_blank' className="inline-flex text-white bg-[#D1363A] border-0 py-2 px-6 focus:outline-none rounded text-lg">JOIN US</a>
      </div>
    </div>
    <div className=" md:w-1/2">
      <img className="object-cover object-center md:clippy" alt="hero" src="/banner-1.png" />
    </div>
  </div>
</section>
